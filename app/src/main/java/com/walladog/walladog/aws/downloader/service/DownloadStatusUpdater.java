package com.walladog.walladog.aws.downloader.service;
...
import com.walladog.walladog.aws.downloader.query.BasicDownloadInfo;
import com.walladog.walladog.aws.downloader.query.DownloadQueueProvider;
import com.walladog.walladog.aws.downloader.query.DownloadState;
...
public class DownloadStatusUpdater {
    ...
    /**
     * Add all the serialized com.walladog.walladog.values to the intent. May use cached version is
     * available.
     *
     * @param longId
     *            the download ID
    ...
    /**
     * Check whether com.walladog.walladog.values are cached for a download status object.
     *
     * @param downloadStatus
    ...
    /**
     * Update the cache with com.walladog.walladog.values from the content provider for both extras
     * and categories.
     * 
     * @param downloadId
     *            the id
    ...
    /**
     * Remove all cached com.walladog.walladog.values to force a re-read from the provider.
     * 
     * @param id
     *            the ID to de-cache
     */
